...
export const offlineAssetList: Asset[] = [
    ...
    },
    {
        ...
        description: '   NOOTYA   Telegram: https://t.me/NOOTYA_TON_OFFICIAL',
        decimals: 9
    },
    {
        name: 'Cheems on Ton',
        ...
        description: 'https://t.me/cheemsonton',
        decimals: 9
    },
    {
        name: 'POODLE',
        ...
        description:
            "One of Telegram CEO Durov's pet dogs 22 years ago. @poodleonton",
        decimals: 9
    },
    {
        name: 'KAITO',
        ...
        description:
            'He has performed at live concerts onstage as an animated projection along with Crypton\'s other Voice Synth characters (like Hatsune Miku). His original codename was "TARO" back during "Project Daisy", the predecessor of VOCALOID, and was one of the original four known vocals for the project.',
        decimals: 9
    },
    {
        name: 'Prince Harry',
    ...
    },
    {
        ...
        description: 'https://t.me/+ulyNAOkDT29hZGU0',
        decimals: 9
    },
    {
        name: 'PONZI JETTON',
        ...
        description: 'https://t.me/Ponzijetton',
        decimals: 9
    },
    {
        name: 'Peng Ricky',
        ...
        description:
            'Mischievous Penguins https://t.me/ricky_ton . https://twitter.com/ricky_tonX . https://rickypenguin.xyz',
        decimals: 6
    },
    {
        name: 'Ton Kitty',
        ...
        description: 'Ton Kitty is the cutest on ton https://tonkitty.net/',
        decimals: 9
    },
    {
        name: 'TON MINT',
        ...
        description: 'TON MINT listing on binance',
        decimals: 9
    }
];

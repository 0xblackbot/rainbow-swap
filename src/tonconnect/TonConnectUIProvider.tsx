...
export interface TonConnectUIProviderPropsWithManifest {
    /**
     * Url to the [manifest]{@link https://github.com/ton-connect/docs/blob/main/requests-responses.md#app-manifest}
     * with the Dapp metadata that will be displayed in the user's wallet. If not passed, manifest from
...
export interface TonConnectUIProviderPropsWithConnector {
    /**
     * TonConnect instance. Can be helpful if you use custom ITonConnect implementation, or use both of @tonconnect/sdk
     * and @tonconnect/ui in your app.
     */
...
export interface TonConnectUIProviderPropsBase {
    ...
    /**
     * HTML element id to attach the modal window element. If not passed, `div#tc-widget-root` in the end of the <body>
    ...
    /**
     * Configuration for action-period (e.g. sendTransaction) UI elements: modals and notifications and wallet
     * behaviour (return strategy).
     */
